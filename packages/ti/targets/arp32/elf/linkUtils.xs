...
function genElfSymbols(prog)
{
    ...
    res += "--symbol_map __TI_cleanup_ptr=_cleanup_ptr\n";
    res += "--symbol_map __TI_dtors_ptr=_dtors_ptr\n";

    return (res);
}
/*
 *  @(#) ti.targets.arp32.elf; 1, 0, 0,0; 12-11-2015 16:22:07; /db/ztree/library/trees/xdctargets/xdctargets-k07/src/ xlibrary
